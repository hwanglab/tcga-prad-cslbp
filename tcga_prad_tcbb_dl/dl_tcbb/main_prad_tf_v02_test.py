...
Test_g6=['../../data_patches/fold3/valid/g6/']  # fold 1
Test_g7=['../../data_patches/fold3/valid/g7/']
Test_g8_9=['../../data_patches/fold3/valid/g8_9/']

model_location='../../models/tf_v2/fold03/'+'model_vgg16_fold3.json'
model_weights='../../models/tf_v2/fold03/'+'model_fold3_weights.h5'
...
def load_model_prediction():
    ...
    savemat("vgg_tf2_fold03.mat", dict([('pID', pIDL), ('preds', preds)]))
