...
class Transfer_Learning_TCBB:
    ...
    def save_bottleneck_features_labels(self,train_num,valid_num):
        ...
        train_labels = np.zeros(shape=(train_num,3)) # 3 subclass in our tcbb case
        i = 0
        ...
        valid_labels = np.zeros(shape=(valid_num,3)) # 3 subclass in our tcbb case
        i = 0
    ...
    def build_top_layers(self,bottleneck_shape):
        model = Sequential()
        model.add(Conv2D(64, (1, 1), input_shape=bottleneck_shape, activation='relu'))
