...
if fold==1:
    Test_g7=['../two_class/fold1/valid/g7/']
    Test_g8_9=['../two_class/fold1/valid/g8_9/']

    model_location='./two_class/fold01_dl/models/'+'model_vgg01_linux.json'
    model_weights='./two_class/fold01_dl/models/'+'model_weights.h5'
elif fold==2:
    Test_g7 = ['../two_class/fold2/valid/g7/']
    Test_g8_9 = ['../two_class/fold2/valid/g8_9/']

    model_location = './two_class/fold01_dl/models/' + 'model_vgg01_linux.json'
    model_weights = './two_class/fold01_dl/models/' + 'model_weights.h5'
elif fold==3:
    Test_g7 = ['../two_class/fold3/valid/g7/']
