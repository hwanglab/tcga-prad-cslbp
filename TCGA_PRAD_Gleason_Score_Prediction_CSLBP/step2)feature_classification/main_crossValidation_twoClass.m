...
function main_crossValidation_twoClass

%rng(100);
% step 1) load and organize features and corresponding labels in a table
trainfeaturePath='./tcga_288_25/';   % proposed cslbp feature groups
...
for i=1:50
    [validationAccuracy,C,scores] = trainClassifier_twoClass_tcbb(FT);       
...
CC=CC./50;
SSC=SSC./50;
%save(strcat('../step3)plot_figures/two_class_evaluation/','proposed_linear.mat'),'SSC','CC');