...
load('proposed_cubic50.mat');
p_cubic_ss=SSC;

load('proposed_gaussian50.mat');
p_gaussian_ss=SSC;

load('fa_cubic_score.mat');
fa_cubic_ss=SSC;
load('fa_gaussian_score.mat');
fa_gaussian_ss=SSC;

load('hhg_cubic_score.mat');
hhg_cubic_ss=SSC;
load('hhg_gaussian_score.mat');
hhg_gaussian_ss=SSC;
...
load('hhg312_cubic_score.mat');
hhg312_cubic=SSC;

load('hhg312_gaussian_score.mat');
hhg312_gaussian=SSC;
